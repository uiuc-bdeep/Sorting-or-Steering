...
ggsave("Cor_White_Poverty.png", width = 8, height = 5)
...
p1 + geom_point(aes(color = WhiteHI_Rec)) +
  ...
  geom_smooth(method='lm')
ggsave("Cor_White_highskill.png", width = 8, height = 5)
...
ggsave("Cor_White_college.png", width = 8, height = 5)
...
p1 + geom_point(aes(color = WhiteHI_Rec)) +
  ...
  geom_smooth(method='lm')
ggsave("Cor_White_School.png", width = 8, height = 5)
...
p1 + geom_point(aes(color = WhiteHI_Rec)) +
  ...
  geom_smooth(method='lm')
ggsave("Cor_White_assault.png", width = 8, height = 5)
...
p1 + geom_point(aes(color = WhiteHI_Rec)) +
  ...
  geom_smooth(method='lm')
ggsave("Cor_White_Superfund.png", width = 8, height = 5)
...
p1 + geom_point(aes(color = WhiteHI_Rec)) +
  ...
  geom_smooth(method='lm')
ggsave("Cor_White_RSEI.png", width = 8, height = 5)
